...
class ETH_API:
    def __init__(self):
        self.INFURA_URL = 'https://mainnet.infura.io/v3/45fd456a1bc349108a08f6c40a23b78c'
        ...
        print(f"Web Is conected: {self.web3.is_connected}")
    ...
    def collect_gas_time(self, token_address, start_block):
        ...
        API_KEY = "PNQX8FD77HVR63TS492NAITKTZXDHXKK6W"
    ...
    def get_transfers(self, token_address, decimal=18):
        ...
        try:
            contract = self.web3.eth.contract(Web3.to_checksum_address(token_address), abi=self.ABI)
        except Exception as err:
            print(f"Exception occured: {err}")
            return
