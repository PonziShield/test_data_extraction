...
class ContractFeatureRealtime(object):
    def __init__(self,internal_transactions,external_transactions, contract_address):
        self.contract_address = contract_address
        self.internal_transactions=internal_transactions
        self.external_transactions=external_transactions
    ...
    def get_contract_total_transaction_count(self):
        ...
        counter = 0
        for in_tx in self.internal_transactions:
            if counter > 0:
                from_address = in_tx["from"]
                to_address = in_tx["to"]
        ...
        locals_contract_total_transaction_count = 0
        counter = 0
        for tx in self.external_transactions:
            if counter > 0:
    ...
    #     for contract in self.external_transactions:
